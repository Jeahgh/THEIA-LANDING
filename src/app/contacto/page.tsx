...
function WhatsAppIcon() {
  return (
    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M20.52 3.48A11.86 11.86 0 0012.08 0C5.5 0 .14 5.35.14 11.93c0 2.1.55 4.16 1.6 5.97L0 24l6.25-1.64a11.91 11.91 0 005.83 1.49h.01C18.66 23.85 24 18.5 24 11.92a11.87 11.87 0 00-3.48-8.44zM12.09 21.83h-.01a9.9 9.9 0 01-5.04-1.38l-.36-.21-3.71.97.99-3.62-.23-.37a9.86 9.86 0 01-1.51-5.29c0-5.46 4.45-9.9 9.91-9.9a9.83 9.83 0 017 2.9 9.84 9.84 0 012.9 7c0 5.46-4.44 9.9-9.94 9.9zm5.43-7.42c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.29-.77.97-.94 1.16-.17.2-.35.22-.64.08-.3-.15-1.25-.46-2.38-1.47a8.93 8.93 0 01-1.65-2.05c-.17-.29-.02-.45.13-.6.13-.13.3-.35.45-.52.15-.18.2-.3.3-.5.1-.2.05-.37-.03-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.5h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.49s1.07 2.89 1.22 3.09c.15.2 2.1 3.2 5.08 4.49.71.31 1.26.49 1.69.63.71.23 1.36.2 1.87.12.57-.08 1.76-.72 2.01-1.42.25-.7.25-1.3.17-1.42-.07-.13-.27-.2-.57-.35z" />
    </svg>
  );
}
...
export default function ContactoPage() {
  ...
  const contactChannels = [
    ...
    { value: CLUB_INFO.phone, href: whatsappUrl },
  ];
            ...
            <div className="flex flex-col justify-center lg:pt-20">
              <Card className="bg-white/85">
                <div className="space-y-3">
                  {contactChannels.map((item) => (
                    <a
                      ...
                      className="flex items-center gap-3 break-all text-base font-semibold text-brand-navy/85 transition-colors hover:text-brand-navy"
                    >
                      <span className="h-2 w-2 shrink-0 rounded-full bg-brand-navy/45" />
                ...
                <div className="mt-7 border-t border-border-subtle pt-6">
                  <h3 className="mb-4 text-base font-bold text-text-primary">Síguenos</h3>
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {SOCIAL_LINKS.map((social) => (
                      <a
                        ...
                        className="flex items-center gap-3 rounded-xl bg-slate-100 px-4 py-3 text-sm font-semibold text-brand-navy transition-colors hover:bg-slate-200 hover:text-brand-navy"
                      >
                        <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white text-brand-navy">
